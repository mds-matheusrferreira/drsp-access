...
<div class="space-y-6">
    <div class="space-y-2">
        <h1 class="text-3xl font-semibold text-gray-900">Planilha Processos - Upload e download de Dados</h1>
        <p class="text-base text-gray-600">Sistema de importação de planilha de Processos</p>
    </div>

    <section class="rounded-lg bg-blue-50 px-5 py-4 text-blue-700" aria-labelledby="informacoes-processos-title">
        <div class="flex gap-3">
            ...
            <div>
                <h2 id="informacoes-processos-title" class="font-semibold">Informações Importantes</h2>
    ...
    <section class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm" aria-labelledby="importar-processos-title">
        <div class="border-b border-green-200 bg-green-100 px-6 py-5">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 id="importar-processos-title" class="text-xl font-semibold text-gray-900">Importar Planilha Processos</h2>
        ...
        <div class="space-y-6 p-6">
            <label for="processos-file" class="flex min-h-64 cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-300 px-6 py-12 text-center transition-colors hover:border-blue-400 hover:bg-blue-50/40">
                ...
                <span id="processos-file-label" class="mt-2 text-sm font-medium text-gray-600">Arquivos Excel (.xlsx, .xls) - Máximo 10MB</span>
                <input id="processos-file" type="file" class="sr-only" accept=".xlsx,.xls">
            </label>

            <button id="processos-submit" type="button" disabled class="inline-flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-lg bg-gray-300 px-4 py-4 text-base font-semibold text-white transition-colors">
                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M7.5 7.5 12 3m0 0 4.5 4.5M12 3v13.5" />
                </svg>
                Enviar Processos
    ...
    <section class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm" aria-labelledby="uploads-recentes-title">
        ...
        <div class="divide-y divide-gray-200">
            @foreach ([
                ['name' => 'processos_geral_2026_05.xlsx', 'date' => '29/05/2026 11:15', 'records' => '542 registros'],
                ['name' => 'processos_geral_2026_04.xlsx', 'date' => '28/04/2026 16:40', 'records' => '421 registros'],
                ['name' => 'processos_geral_2026_03.xlsx', 'date' => '25/03/2026 10:22', 'records' => '618 registros'],
            ] as $upload)
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const fileInput = document.getElementById('processos-file');
        const fileLabel = document.getElementById('processos-file-label');
        const submitButton = document.getElementById('processos-submit');

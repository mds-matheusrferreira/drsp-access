...
@switch($name)
    ...
    @case('folder')
        <svg class="h-5 w-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V6.75A2.25 2.25 0 0 1 4.5 4.5h4.879c.597 0 1.169.237 1.591.659l1.121 1.121c.422.422.994.659 1.591.659H19.5a2.25 2.25 0 0 1 2.25 2.25v3.562M2.25 12.75l2.159 6.477A2.25 2.25 0 0 0 6.544 20.75h10.912a2.25 2.25 0 0 0 2.135-1.523l2.159-6.477M2.25 12.75h19.5" />
        </svg>
        @break
    @case('settings')
        <svg class="h-5 w-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">

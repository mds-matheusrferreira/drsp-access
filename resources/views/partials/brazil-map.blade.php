    ...
    <div class="flex items-start justify-center">
        <div class="shrink-0">
            ...
            <g>
                ...
                <a xlink:href="#riograndedonorte" class="estado" name="Rio Grande do Norte"
                    code="24">
                    <path stroke="#FFFFFF" stroke-width="1.0404" stroke-linecap="round"
                        stroke-linejoin="round"
                        d="M404.698,138.795
                ...
                <a xlink:href="#mattogrossodosul" class="estado" name="Mato Grosso do Sul"
                    code="50">
                    <path stroke="#FFFFFF" stroke-width="1.0404" stroke-linecap="round"
                        stroke-linejoin="round"
                        d="M183.198,294.536
                ...
                <a xlink:href="#riograndedosul" class="estado" name="Rio Grande do Sul"
                    code="43">
                    <path stroke="#FFFFFF" stroke-width="1.0404" stroke-linecap="round"
                        stroke-linejoin="round"
                        d="M191.236,416.881
                ...
                <a xlink:href="#minasgerais" class="estado" name="Minas Gerais" code="31" data-estado="MG">
                    <path stroke="#FFFFFF" stroke-width="1.0404" stroke-linecap="round"
                ...
                <a xlink:href="#distritofederal" class="estado" name="Distrito Federal"
                    code="53">
                    <path stroke="#FFFFFF" stroke-width="1.0404" stroke-linecap="round"
